...
words_strip = words_1.strip(' ')
words_upper = words_2.upper()
words_len = words_3.count('o')
words_replace = words_4.replace(",", "!")
...
hundred_text = '100'
hundred_numb = int(hundred_text)
print(type(hundred_numb), hundred_numb)

pi_float = 3.14
pi_text = str(pi_float)
print(type(pi_text),pi_text)

bool_true = True
bool_text = str(bool_true)
print(type(bool_text), bool_text)

#hm3

numb_1 = int(input('Введите первое число: '))
numb_2 = int(input('Введите второе число: '))
math = f'{numb_1} + {numb_2} = {numb_1 + numb_2}'
print(math)